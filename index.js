...
rl.question("Por favor, insira seu nome: ", function(nome) {
  // Pede ao usuário para inserir a exp
  rl.question("Agora, insira sua experiência: ", function(exp) {
    // Fecha a interface de leitura
    rl.close();

    // Verifica se o usuário inseriu um nome e uma exp válida
    if (nome.trim() !== "" && !isNaN(exp) && exp > 0 && exp < 1000)  
        {
        // Exibe uma mensagem de saudação com o nome e a exp
        ...
        {
            // Exibe uma mensagem se o nome ou a exp não forem válidos
